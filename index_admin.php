				...
				<div class="container">
					...
					<ul class="main-nav nav navbar-nav navbar-right">
						...
						<li class="has-dropdown"><a href="#blog">Funciones</a>
							<ul class="dropdown">
								<li><a href="#almuerzos">Agregar promociones</a></li>
								<li><a href="funciones_del_administrador/vista/editar_almuerzos.php">Modificar menú de almuerzos</a></li>
								<li><a href="#eventos">Modificar menú de helados</a></li>
							</ul>
						</li>
